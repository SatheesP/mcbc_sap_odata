class ZCL_MCBC_MEAL_AIRLINE1_DPC definition
  public
...
protected section.
  ...
  methods MEALSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_MCBC_MEAL_AIRLINE1_MPC=>TS_MEAL
    raising
  ...
  methods MEALSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_MCBC_MEAL_AIRLINE1_MPC=>TT_MEAL
...
CLASS ZCL_MCBC_MEAL_AIRLINE1_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 16.11.2022 11:48:15 in client 011
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE1_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA mealset_create_entity TYPE zcl_mcbc_meal_airline1_mpc=>ts_meal.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_get_entity TYPE zcl_mcbc_meal_airline1_mpc=>ts_meal.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE1_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA mealset_get_entityset TYPE zcl_mcbc_meal_airline1_mpc=>tt_meal.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_update_entity TYPE zcl_mcbc_meal_airline1_mpc=>ts_meal.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
