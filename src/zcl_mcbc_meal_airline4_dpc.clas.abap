class ZCL_MCBC_MEAL_AIRLINE4_DPC definition
  public
...
protected section.
  ...
  methods AIRLINES_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_MCBC_MEAL_AIRLINE4_MPC=>TS_AIRLINE
    raising
  ...
  methods AIRLINES_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_MCBC_MEAL_AIRLINE4_MPC=>TT_AIRLINE
  ...
  methods MEALSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_MCBC_MEAL_AIRLINE4_MPC=>TS_MEAL
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods MEALSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_MCBC_MEAL_AIRLINE4_MPC=>TT_MEAL
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_MCBC_MEAL_AIRLINE4_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 22.11.2022 09:06:23 in client 011
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE4_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA mealset_create_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_meal.
 DATA airlines_create_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_airline.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_get_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_meal.
 DATA airlines_get_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_airline.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE4_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA mealset_get_entityset TYPE zcl_mcbc_meal_airline4_mpc=>tt_meal.
 DATA airlines_get_entityset TYPE zcl_mcbc_meal_airline4_mpc=>tt_airline.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_update_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_meal.
 DATA airlines_update_entity TYPE zcl_mcbc_meal_airline4_mpc=>ts_airline.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
