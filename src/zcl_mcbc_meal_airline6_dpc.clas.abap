class ZCL_MCBC_MEAL_AIRLINE6_DPC definition
  public
...
protected section.
  ...
  methods AIRLINES_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_MCBC_MEAL_AIRLINE6_MPC=>TS_AIRLINE
    raising
  ...
  methods AIRLINES_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_MCBC_MEAL_AIRLINE6_MPC=>TT_AIRLINE
  ...
  methods MEALSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_MCBC_MEAL_AIRLINE6_MPC=>TS_MEAL
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods MEALSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_MCBC_MEAL_AIRLINE6_MPC=>TT_MEAL
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_MCBC_MEAL_AIRLINE6_DPC IMPLEMENTATION.
...
*&* This class has been generated on 18.11.2022 06:13:08 in client 011
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE6_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA mealset_create_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_meal.
 DATA airlines_create_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_airline.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_get_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_meal.
 DATA airlines_get_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_airline.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_MCBC_MEAL_AIRLINE6_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA mealset_get_entityset TYPE zcl_mcbc_meal_airline6_mpc=>tt_meal.
 DATA airlines_get_entityset TYPE zcl_mcbc_meal_airline6_mpc=>tt_airline.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mealset_update_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_meal.
 DATA airlines_update_entity TYPE zcl_mcbc_meal_airline6_mpc=>ts_airline.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    DATA(lv_sadl_xml) =
               ...
               | </sadl:query>| &
               | <sadl:attribute name="AIRLINEID" binding="AIRLINEID" isKey="TRUE" />| &
               | <sadl:attribute name="NAME" binding="NAME" isKey="FALSE" />| &
               | <sadl:attribute name="CURRENCYCODE" binding="CURRENCYCODE" isKey="FALSE" />| &
               | <sadl:attribute name="URL" binding="URL" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = '20221118051257'
               iv_uuid              = 'ZMCBC_MEAL_AIRLINE6'
               io_query_control     = me
