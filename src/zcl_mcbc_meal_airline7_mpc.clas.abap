class ZCL_MCBC_MEAL_AIRLINE7_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_MCBC_MEAL_AIRLINE7_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_MCBC_MEAL_AIRLINE7_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMCBC_MEAL_AIRLINE7_SRV' ).
